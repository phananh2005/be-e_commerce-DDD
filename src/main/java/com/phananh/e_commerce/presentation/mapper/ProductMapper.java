...
public interface ProductMapper {
    ...
    @Mapping(target = "minPrice", expression = "java(product.getVariants().stream().map(com.phananh.e_commerce.domain.model.entity.ProductVariant::getPrice).min(java.math.BigDecimal::compareTo).orElse(java.math.BigDecimal.ZERO))")
